...
DECLARE @Test money;
SET @Test = MAX(UnitPrice) FROM Sales.SalesOrderDetail);
SELECT @Test;
...
sqlcmd -Usa -P000000 -Slocalhost\sql2008 -Q "select * from adventureworks2008.production.location"
sqlcmd -E -Slocalhost\sql2008 -Q "select * from adventureworks2008.production.location"
...
exec('SELECT ''The Rowcount is '' + CAST(@@ROWCOUNT as varchar)');
