		...
		bdList: ["mshare,\u4e00\u952e\u5206\u4eab,mshare", "qzone,QQ\u7a7a\u95f4,qqkj", "tsina,\u65b0\u6d6a\u5fae\u535a,xlwb", "baidu,\u767E\u5EA6\u4E91\u6536\u85CF,bdsc", "renren,\u4eba\u4eba\u7f51,rrw", "tqq,\u817e\u8baf\u5fae\u535a,txwb", "bdxc,\u767e\u5ea6\u76f8\u518c,bdxc", "kaixin001,\u5f00\u5fc3\u7f51,kxw", "tqf,\u817e\u8baf\u670b\u53cb,txpy", "tieba,\u767e\u5ea6\u8d34\u5427,bdtb", "douban,\u8c46\u74e3\u7f51,db", "tsohu,\u641c\u72d0\u5fae\u535a,shwb", "bdhome,\u767e\u5ea6\u65b0\u9996\u9875,bdhome", "sqq,QQ\u597D\u53CB,sqq", "thx,\u548c\u8baf\u5fae\u535a,thx", "qq,QQ\u6536\u85cf,qqsc", "taobao,\u6211\u7684\u6dd8\u5b9d,tjh", "hi,\u767e\u5ea6\u7a7a\u95f4,bdkj", "msn,MSN,msn", "sohu,\u641c\u72d0\u767d\u793e\u4f1a,shbsh", "t163,\u7f51\u6613\u5fae\u535a,wywb", "qy,\u5947\u827a\u5947\u8c08,qyqt", "meilishuo,\u7f8e\u4e3d\u8bf4,mls", "mogujie,\u8611\u83c7\u8857,mgj", "diandian,\u70b9\u70b9\u7f51,diandian", "huaban,\u82b1\u74e3,huaban", "leho,\u7231\u4e50\u6d3b,leho", "share189,\u624B\u673A\u5FEB\u4F20,share189", "duitang,\u5806\u7cd6,duitang", "hx,\u548c\u8baf,hexun", "tfh,\u51e4\u51f0\u5fae\u535a,fhwb", "fx,\u98de\u4fe1,feixin", "youdao,\u6709\u9053\u4e91\u7b14\u8bb0,youdao", "sdo,\u9EA6\u5E93\u8BB0\u4E8B,sdo", "qingbiji,\u8F7B\u7B14\u8BB0,qingbiji", "ifeng,\u51E4\u51F0\u5FEB\u535A,ifeng", "people,\u4EBA\u6C11\u5FAE\u535A,people", "xinhua,\u65B0\u534E\u5FAE\u535A,xinhua", "ff,\u996d\u5426,fanfou", "mail,\u90ae\u4ef6\u5206\u4eab,mail", "kanshou,\u641C\u72D0\u968F\u8EAB\u770B,kanshou", "isohu,\u6211\u7684\u641C\u72D0,isohu", "yaolan,\u6447\u7BEE\u7A7A\u95F4,yaolan", "wealink,\u82e5\u90bb\u7f51,wealink", "tuita,\u63A8\u4ED6,tuita", "xg,\u9c9c\u679c,xianguo", "ty,\u5929\u6daf\u793e\u533a,tianya", "fbook,Facebook,facebook", "twi,Twitter,twitter", "ms,Myspace,myspace", "deli,delicious,delicious", "s51,51\u6E38\u620F\u793e\u533a,51shequ", "s139,139\u8bf4\u5ba2,shuoke", "linkedin,linkedin,LinkedIn", "copy,\u590d\u5236\u7f51\u5740,kaobei", "print,\u6253\u5370,print"]
			...
			_jump: function(AV, AU, B, AD, AC) {
				var AT = Z,
					...
					u = AT.bdComment,
					o = AT.bdMiniWindow || 0;
				C = (AU.getAttribute("data") && AU.getAttribute("data") != "") ? J._parseJson(AU.getAttribute("data")) : C;
				if (C != "") {
					...
					if (AV == "tsina") {
						if (C.text && C.weibotext) {
							U = encodeURIComponent((C.text + C.weibotext).substr(0, 300))
						} else {
							if (C.weibotext) {
								U = encodeURIComponent((U + C.weibotext).substr(0, 300))
							} else {
								if (C.text) {
									U = encodeURIComponent((C.text + z).substr(0, 300))
								} else {
						...
						U = encodeURIComponent((C.text || "").substr(0, 300)) || encodeURIComponent(U.substr(0, 300))
					}
				} else {
					if (AV == "tsina") {
						U = encodeURIComponent((U + z).substr(0, 300))
				...
				var AI = +new Date;
				AI = AI - AU.time;
				var j = [T, E, n, AH, AE, i, e, AF, AQ, k, AI, p, AA, r, AG].join(".");
				var D;
				switch (Z.bdType) {
					case "button":
						D = 1;
				...
				var q = "?click=1&url=" + encodeURIComponent(window.shareLemmaUrl) + "&uid=" + AT.bdUid + "&to=" + AW + "&type=text&relateUid=" + AL + "&pic=" + AB + "&title=" + U + "&key=" + (AT.snsKey[AV] || "") + "&sign=" + AT.review + "&desc=" + AK + "&comment=" + u + "&searchPic=" + AT.searchPic + "&l=" + AN + "&linkid=" + H + "&sloc=" + j + "&apiType=0&buttonType=" + D + "&firstime=" + J.getCookie("bdshare_firstime");
				var q1 = "?click=1&url=" + encodeURIComponent(window.shareLemmaUrl) + "&uid=" + AT.bdUid + "&to=" + AW + "&type=text&relateUid=" + AL + "&pic=" + AB + "&title=" + U + "&key=" + (AT.snsKey[AV] || "") + "&sign=" + AT.review + "&desc=" + AK + "&comment=" + u + "&searchPic=" + AT.searchPic + "&l=" + AN + "&linkid=" + H + "&sloc=" + j + "&apiType=0&buttonType=" + D + "&firstime=" + J.getCookie("bdshare_firstime"); 
				if (AV == "mshare") {
					var AS = AT.bdMshare + q1
				} else {
					var AS = AT.bdCommit + q1
				}
				...
				if (AV != "goWebsite") {
					...
					if (AV == "bdxc") {
						...
						if (AR[AM]) {
							...
							AJ.src = "http://xiangce.baidu.com/zt/collect/mark.js?" + (new Date()).getTime();
						...
						if (AV == "mail") {
							...
							if (1 == o) {
								F.open(AS, "bdShare", "toolbar=0, scrollbars=1, status=0, resizable=1, height=400, width=600")
							} else {
								F.open(AS)
							}
						}
		...
		return {
			...
			_getSc: function(D) {
				...
				if (this.s.length > 0) {
					...
					J.callByBrowser(this.conf.bdApi + "getnum?url=" + encodeURIComponent(window.shareLemmaUrl) + "&callback=bdShare.fn._getShare&type=" + D + "&t=" + new Date().getTime())
				}
			},
